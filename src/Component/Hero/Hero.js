        ...
        <div className='!scroll-smooth'>
            ...
            <section className="relative">
                <video className='absolute inset-0  z-0 video  lg:mt-0 mt-16 w-full md:h-[55rem] h-[18.5rem] object-cover' autoPlay muted loop>
                    <source src={bgvideo} className='' type='video/mp4'></source>
                </video>
                <div className=' mx-auto relative z-10 '>
                    <Navbar />
                    
                    <div className='lg:pt-44 md:pt-32 pt-36 md:px-10 px-3.5 text-center  ' style={{ fontFamily: '"League spartan",sans-serif' }}>
                    ...
                    <div className='border-2 border-[#2976b6] md:mt-12 mt-32 mx-4 md:mx-12 rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] md:border-orange-600 lg:w-[818px] lg:h-[480px] lg:rounded-xl bg-white lg:mt-10 lg:mx-auto' style={{ fontFamily: '"League spartan",sans-serif' }}>
                            ...
                            <form>
                                <div class=" mt-5 grid lg:grid-cols-3 md:grid-cols-2 lg:gap-3 gap-6 ">
                                    <div class="relative z-0 group ">
                                        <input type="email" name="floating_email" id="floating_email" class="w-full  lg:w-60  hover:border-black block py-2.5 px-3 text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Name*</label>
                                        <label className='text-xs ml-1 text-red-500 hidden lg:block'>Required</label>
                                    </div>
                                    <div class="relative z-0  group  ">
                                        <input type="email" name="floating_email" id="floating_email" class="w-full  lg:w-60  hover:border-black block py-2.5 px-3   text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email Address *</label>
                                        <label className='text-xs ml-1  text-red-500 hidden lg:block'>Required</label>
                                    </div>
                                    <div class="relative z-0  group  ">
                                        <input type="email" name="floating_email" id="floating_email" class="w-full  lg:w-60  hover:border-black block py-2.5 px-3  text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Mobile Number*</label>
                                    </div>
                                    <div class="relative z-0  group  ">
                                        <input type="email" name="floating_email" id="floating_email" class="w-full  lg:w-60  hover:border-black block py-2.5 px-3  text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Destination</label>
                                    </div>
                                    <div class="relative z-0  group  ">
                                        <input type="email" name="floating_email" id="floating_email" class="w-full  lg:w-60 hover:border-black block py-2.5 px-3   text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Add atrraction</label>
                                    </div>
                                    <div class="relative z-0  group  ">
                                        <input name="floating_email" id="floating_email" class="w-full  lg:w-60 hover:border-black block py-2.5 px-3  text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " type="number" required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">No of Days</label>
                                    </div>
                                ...
                                <div className='md:flex gap-4 '>
                                    <div class="relative z-0  group  ">
                                        ...
                                        <input name="floating_email" id="floating_email" class="w-full  lg:w-44  hover:border-black  block py-2.5 px-3    text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " type="date" required />
                                    </div>
                                    <div class="relative z-0  group  ">
                                    ...
                                    <div class="relative z-0  group    mt-6 md:inline-block">
                                        <textarea type="email" name="floating_email" id="floating_email" class="hover:border-black  block py-2.5 px-3 w-full resize-none  md:w-[20.8rem] lg:w-[23rem] md:h-[7rem]   text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" "></textarea>
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Special Request</label>
                                    </div>
                                </div>
                                <div className='md:flex md:gap-4 mt-5 md:-mt-[2.6rem]'>
                                    <div class="relative z-0  group  ">
                                        <input name="floating_email" id="floating_email" class="w-full  lg:w-44 md:w-[9.3rem]  hover:border-black  block py-2.5 px-3   text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " type="number" required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">No of Adult *</label>
                                        <label className='text-xs ml-1  text-red-500 hidden lg:block'>Required</label>
                                    </div>
                                    <div class="relative z-0  group  mt-5 md:mt-0">
                                        <input name="floating_email" id="floating_email" class="w-full  lg:w-44 md:w-[9.3rem]  hover:border-black  block py-2.5 px-3   text-sm  bg-transparent  border-2 border-gray-300 rounded-md appearance-none  focus:outline-none focus:ring-0 focus:border-blue-500 peer" placeholder=" " type="number" required />
                                        <label for="floating_email" class="peer-focus:font-medium ml-3 absolute text-xs   duration-300 transform -translate-y-6  scale-80 top-2 -z-10 origin-[0] peer-focus:start-0 text-gray-500   rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto  peer-focus:text-blue-500 peer-focus:top-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">No of Child *</label>
                                    </div>
                                </div>
                                <div className='flex mt-5'>
                                    <button className='mx-auto px-5 py-2 rounded-md font-semibold  text-white hover:text-orange-500  text-sm hover:bg-white  bg-orange-500 border-2 hover:border-orange-500' >Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <section className='mt-36 mx-auto'>
                ...
                <div className='hidden md:block'>
                    <div className='flex  mt-12 justify-center lg:gap-48 md:gap-24' style={{ color: 'rgb(237, 125, 44)' }}>
                    ...
                    <img className='mx-auto w-[70%] ' src={flow} />
                    <div className='flex lg:gap-52 md:gap-24 justify-center mt-3' style={{ color: 'rgb(237, 125, 44)' }}>
            ...
            < section className='mt-24 mx-auto ' >
                <div className='flex justify-center '>
                    <h1 className='text-center text-[#2976b6] font-bold lg:text-3xl text-lg'>Best Sellings</h1>
                </div>
                <Best />
            </section >
            {/* Our Destination */}
