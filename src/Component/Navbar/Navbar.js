        ...
        <div className='fixed z-50 w-full'>
            <nav className='bg-white   shadow-[0_3px_10px_rgb(0,0,0,0.2)] ' style={{ fontFamily: '"League spartan",sans-serif' }}>
                <div className='flex justify-between'>
                    <div className='lg:ml-16 ml-5 lg:my-2 my-3'>
                    ...
                    <div className='mx-auto my-auto lg:block  hidden '>
                        <ul className='flex lg:gap-8 font-semibold tracking-wide text-[#2976b6]  ml-96'>
                            <Link to="/best-selling"><li className='cursor-pointer hover:scale-110 duration-300'>Best Selling</li></Link>
                            <Link to="/Packages" ><li className='cursor-pointer hover:scale-110 duration-300'>Packages</li></Link>
                    ...
                    <div className='bg-[#2976b6] mr-14 w-52 lg:block  hidden '>
                        <div className='flex'>
                            ...
                            <li className='list-none  text-center text-xl font-light mt-[1.35rem] ml-2 text-white'>01622 960422</li>
                        </div>
                    </div>
                </div>
                <div className="bg-white shadow-lg sm:px-8   text-[#2976b6] tracking-wide">
                    <ul id="mobileMenu" className=" hidden   flex-wrap  font-bold  mt-20 h-screen  ">
                        ...
                        <Link to='/Contact-us'> <li className="flex  justify-center mt-5 hover:bg-[#2976b6] w-80 py-1.5 rounded-lg mx-auto hover:text-white">
                            Contact Us</li></Link>
                        <Link to='/Contact'> <li className="flex justify-center  mt-5 hover:bg-[#2976b6] w-80 py-1.5 rounded-lg mx-auto hover:text-white">
                            Call Now</li></Link>
                    </ul>
                </div>
            </nav >
