                        ...
                        <div className="embla w-full rounded-lg lg:rounded-xl border-[3px] border-[#2976b6] shadow-[0_3px_10px_rgb(0,0,0,0.2)]   md:border-orange-500 " ref={emblaRef}>
                            <div className="embla__container shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                                <div className="embla__slide ">
                                    <img src={kerala1} alt='kerala' className='object-cover w-full' />
                                </div>
                                <div className="embla__slide ">
                                    <img src={kerala3} alt='kerala' className='object-cover w-full h-full lg:h-fit' />
                                </div>
                                <div className="embla__slide ">
                                    <img src={kerala5} alt='kerala' className='object-cover w-full h-full lg:h-fit' />
                                </div>
                            </div>
                        </div>
                    </div>
