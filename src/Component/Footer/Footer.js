...
const Footer = () => {
    return (
        <section className='mx-auto'>
            <div className='bg-[#2976b6]  lg:h-[35rem] mx-auto z-20'>
                ...
                <p className='text-center   text-white font-medium lg:text-lg text-sm mt-10 lg:mt-10'>Your Booking Expert © 2023 | Design and Developed By Techbrain Networks.</p>
            </div>
        </section>
    )
}
